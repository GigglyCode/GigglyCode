...
class Compiler {
  ...
  private:
    ...
    std::tuple<std::vector<llvm::Value*>, std::shared_ptr<enviornment::RecordClassType>> _visitInfixExpression(
    ...
    std::tuple<std::vector<llvm::Value*>, std::shared_ptr<enviornment::RecordClassType>> _visitCallExpression(std::shared_ptr<AST::CallExpression>);
    ...
    std::tuple<std::vector<llvm::Value*>, std::shared_ptr<enviornment::RecordClassType>> _resolveValue(std::shared_ptr<AST::Node> node);
};
} // namespace compiler
