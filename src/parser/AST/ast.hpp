...
class genericType : public baseType {
  public:
    ...
    inline genericType(std::shared_ptr<expression> name,
                       std::vector<std::shared_ptr<baseType>> generics)
...
class expressionStatement : public statement {
  public:
    ...
    inline expressionStatement(std::shared_ptr<expression> expr = nullptr)
        : expr(expr) {}
...
class returnStatement : public statement {
  public:
    ...
    inline returnStatement(std::shared_ptr<expression> value = nullptr)
        : value(value) {}
  ...
  public:
    class parameter : public node {
      public:
        ...
        inline parameter(std::shared_ptr<expression> name,
    ...
    inline functionStatement(std::shared_ptr<expression> name,
                             std::vector<std::shared_ptr<parameter>> parameters,
                             std::shared_ptr<baseType> returnType,
                             std::shared_ptr<statement> body)
...
class variableDeclarationStatement : public statement {
  public:
    ...
    std::shared_ptr<baseType> valueType;
    std::shared_ptr<expression> value;
    inline variableDeclarationStatement(
        std::shared_ptr<expression> name, std::shared_ptr<baseType> type,
        std::shared_ptr<expression> value = nullptr)
        : name(name), valueType(type), value(value) {}
    inline nodeType type() override {
...
class variableAssignmentStatement : public statement {
  public:
    std::shared_ptr<expression> name;
    std::shared_ptr<expression> value;
    inline variableAssignmentStatement(std::shared_ptr<expression> name,
                                       std::shared_ptr<expression> value)
        : name(name), value(value) {}
    inline nodeType type() override {
        return nodeType::VariableAssignmentStatement;
    };
    std::shared_ptr<nlohmann::json> toJSON() override;
};
...
class infixExpression : public expression {
  public:
    ...
    token::tokenType op;
    inline infixExpression(std::shared_ptr<expression> left,
                           token::tokenType op,
